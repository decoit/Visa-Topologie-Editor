...
/**
 * This HttpHandler implementation handles requests to remove an existing VLAN.
 * This operation is only possible if there are no interfaces that are assigned
 * to this VLAN.<br>
 * <br>
 ...
 * @see DefaultHandler
 */
public class RemoveVLANHandler extends DefaultHandler {
	private static Logger log = Logger.getLogger(RemoveVLANHandler.class.getName());
