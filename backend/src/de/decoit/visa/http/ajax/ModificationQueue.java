...
public class ModificationQueue {
	 ...
	 * {@link de.decoit.visa.enums.ModificationTarget ModificationTarget} enum
	 * class, modified attributes of these targets in the
	 * {@link de.decoit.visa.enums.ModificationTargetAttribute
	 * ModificationTargetAttribute} enum class.<br>
	 * <br>
